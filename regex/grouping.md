...
| `$`       | Find only characters at the beginning of a line, prefix a expression with the ^ sign.                                                                                                                                                                                                                                                                                                                                                           | 1. `\.html$`<br/>2. `\.sol$` | Matches only the last character especification. Solo marca los `.html` y `.sol` que esten al final                   |
